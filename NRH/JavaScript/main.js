	$(document).ready(function() {
		...
		$("#calcu").click(function() { // the click function starts here//
			...
			if ((weight2 == 0)) {
				...
				$("#ResultText").show();
				$("#ResultText").html("<h3>Din hästs vikt är : " + weight + ' Kg' + "</h3>" + "<h3>Din hästs dagsbehov är: </h3>" + "<h4>" + "Utfodring typ : " + Horse2 + '<br/>' + "</h4>" + "Energi (MJ) : " + feed + "<br/>" + "Smältbart protein : " + prot + "g" + '<br/>' + "Kalcium : " + kal + "g" + '<br/>' + "Fosfers : " + fos + "g" + '<br/>' + "Magnien : " + mag + "g" + '<br/>' + "Seleniam : " + SE + "g" + '<br/>' + "TS : " + TS + "Kg" + '<br/>');
			}
			...
			if ((HayFeedWeight == 0)) { //  1st USER result output  //
				...
				$("#Result11").show();
				$("#Result11").html("<h3>Här är ditt kemiska in resultat 1:</h3> " + "<h3>" + 'Ditt hö du valde:' + HayType + "</h3>" + "<h4>" + "Du matar din häst med : " + HayFeedTotal + " Kg</h4>" + "<h3>" + "Ditt hös egenskaper" + "</h3>" + 'Energi (MJ) :' + EnergyLeft + EnergyIntake1 + '<br/>' + '<br/>' + 'Smältbart protein :' + ProtineLeft1 + ' g' + ProtineIntake1 + '<br/>' + '<br/>' + 'Kalcium  :' + CalciumLeft1 + ' g' + CalcmIntake1 + '<br/>' + '<br/>' + 'Fosfor  :' + FosferLeft1 + ' g' + FosIntake1 + '<br/>' + '<br/>' + 'Magnesium :' + MagLeft1 + ' g' + MagIntake1 + '<br/>' + '<br/>' + 'Seleniam  :' + SELeft1 + ' g' + SEIntake1 + '<br/>' + '<br/>' + 'TS :' + TSLeft1 + TSIntake1 + '<br/>' + '<br/>' + "<h4>Din MJ/SMBRP och CA/P :</h4>" + 'MJ/SMBRP :' + MJandSMRP1 + '<br/>' + 'CA/P :' + CaAndP1 + '<br/>');
			}
			...
			if ((MJ_Input2 == 0)) { //  2nd USER result output  //
				...
				$("#Result22").show();
				$("#Result22").html("<h3>Här är din kemiska in resultat 2:</h3> " + "<h3>" + 'Ditt hö du valde:' + HayType + "</h3>" + "<h4>" + "Din Hös vikt: " + HayFeedTotal + " Kg</h4>" + "<h3>" + "Ditt hös egenskaper" + "</h3>" + 'Energi (MJ) :' + EnergyLeft2 + EnergyIntake2 + '<br/>' + '<br/>' + 'Smältbart protein :' + ProtineLeft2 + ' g' + ProtineIntake2 + '<br/>' + '<br/>' + 'Kalcium  :' + CalciumLeft2 + ' g' + CalcmIntake2 + '<br/>' + '<br/>' + 'Fosfor  :' + FosferLeft2 + ' g' + FosIntake2 + '<br/>' + '<br/>' + 'Magnesium :' + MagLeft2 + ' g' + MagIntake2 + '<br/>' + '<br/>' + 'Seleniam  :' + SELeft2 + ' g' + SEIntake2 + '<br/>' + '<br/>' + 'TS :' + TSLeft2 + TSIntake2 + '<br/>' + '<br/>' + "<h4>Din MJ/SMBRP och CA/P </h4>" + 'MJ/SMBRP :' + MJandSMRP2 + '<br/>' + 'CA/P :' + CaAndP2 + '<br/>');
			}
			...
			if ((MJ_Input3 == 0)) {
				...
				$("#Result33").show();
				$("#Result33").html("<h3>Här är din kemiska in resultat 3:</h3> " + "<h3>" + 'Ditt hö du valde:' + HayType + "</h3>" + "<h4>" + "Din Hös vikt: " + HayFeedTotal + " Kg</h4>" + "<h3>" + "Ditt hös egenskaper" + "</h3>" + 'Energi (MJ) :' + EnergyLeft3 + EnergyIntake3 + '<br/>' + '<br/>' + 'Smältbart protein :' + ProtineLeft3 + ' g' + ProtineIntake3 + '<br/>' + '<br/>' + 'Kalcium  :' + CalciumLeft3 + ' g' + CalcmIntake3 + '<br/>' + '<br/>' + 'Fosfor  :' + FosferLeft3 + ' g' + FosIntake3 + '<br/>' + '<br/>' + 'Magnesium :' + MagLeft3 + ' g' + MagIntake3 + '<br/>' + '<br/>' + 'Seleniam  :' + SELeft3 + ' g' + SEIntake3 + '<br/>' + '<br/>' + 'TS :' + TSLeft3 + TSIntake3 + '<br/>' + '<br/>' + "<h4>Din MJ/SMBRP and CA/P </h4>" + 'MJ/SMBRP :' + MJandSMRP3 + '<br/>' + 'CA/P :' + CaAndP3 + '<br/>');
			}
			...
			if ((MJ_Input4 == 0)) {
				...
				$("#Result44").show();
				$("#Result44").html("<h3>Här är din kemiska in resultat 4:</h3> " + "<h3>" + 'Ditt hö du valde:' + HayType + "</h3>" + "<h4>" + "Din Hös vikt: " + HayFeedTotal + " Kg</h4>" + "<h3>" + "Ditt hös egenskaper" + "</h3>" + 'Energi (MJ) :' + EnergyLeft4 + EnergyIntake4 + '<br/>' + '<br/>' + 'Smältbart protein :' + ProtineLeft4 + ' g' + ProtineIntake4 + '<br/>' + '<br/>' + 'Kalcium  :' + CalciumLeft4 + ' g' + CalcmIntake4 + '<br/>' + '<br/>' + 'Fosfor  :' + FosferLeft4 + ' g' + FosIntake4 + '<br/>' + '<br/>' + 'Magnesium :' + MagLeft4 + ' g' + MagIntake4 + '<br/>' + '<br/>' + 'Seleniam  :' + SELeft4 + ' g' + SEIntake4 + '<br/>' + '<br/>' + 'TS :' + TSLeft4 + TSIntake4 + '<br/>' + '<br/>' + "<h4>Din MJ/SMBRP och CA/P </h4>" + 'MJ/SMBRP :' + MJandSMRP4 + '<br/>' + 'CA/P :' + CaAndP4 + '<br/>');
			}
			...
			if ((MJ_Input5 == 0)) {
				...
				$("#Result55").show();
				$("#Result55").html("<h3>din kemiska i resultat 5:</h3> " + "<h3>" + 'Ditt hö du valde:' + HayType + "</h3>" + "<h4>" + "Din Hös vikt: " + HayFeedTotal + " Kg</h4>" + "<h3>" + "Ditt hös egenskaper" + "</h3>" + 'Energi (MJ) :' + EnergyLeft5 + EnergyIntake5 + '<br/>' + '<br/>' + 'Smältbart protein :' + ProtineLeft5 + ' g' + ProtineIntake5 + '<br/>' + '<br/>' + 'Kalcium  :' + CalciumLeft5 + ' g' + CalcmIntake5 + '<br/>' + '<br/>' + 'Fosfor  :' + FosferLeft5 + ' g' + FosIntake5 + '<br/>' + '<br/>' + 'Magnesium :' + MagLeft5 + ' g' + MagIntake5 + '<br/>' + '<br/>' + 'Seleniam  :' + SELeft5 + ' g' + SEIntake5 + '<br/>' + '<br/>' + 'TS :' + TSLeft5 + TSIntake5 + '<br/>' + '<br/>' + "<h4>Din MJ/SMBRP och CA/P </h4>" + 'MJ/SMBRP :' + MJandSMRP5 + '<br/>' + 'CA/P :' + CaAndP5 + '<br/>');
			}
			...
			if ((days == 0)) {
				...
				$("#ResultTravGalopp").html("<h3>Din häst tränar i :</h3>" + skrittCalc + ": Timmar skritt i veckan" + '<br/>' + travCalc + ": Timmar Trav i veckan" + '<br/>' + '<br/>' + "<h4>Din hästs energibehov är: </h4>" + +workoutMJ + ": MJ efter Trav/Galopp " + '<br/>');
			}
			...
			if (horseFoodChecked.val() == undefined) { // if nothing is checked, then return nothing.
				...
				$.each(horseFoodChecked, function() {
					foodCheckBox = (
					proteinFoder[horseFoodChecked.val()][0] + " har " + proteinFoder[horseFoodChecked.val()][1] + "% TS, " + proteinFoder[horseFoodChecked.val()][2] + " MJ, " + proteinFoder[horseFoodChecked.val()][3] + " smb.rp, " + proteinFoder[horseFoodChecked.val()][4] + " Ca, " + proteinFoder[horseFoodChecked.val()][5] + " P, " + proteinFoder[horseFoodChecked.val()][6] + " Mg <br>")
				});
			...
			if ((MJtxtArea == 0)) {
				...
				$("#Foodfield1").show();
				$("#Foodfield1").html("<h3>" + ' Proteinfodermede ' + '</h3>' + "<h4>" + '<br/>' + 'Kolumnen: 1' + '<br/>' + 'MJ: ' + MJtxtArea + '  &nbsp;&nbsp; ' + 'SMBRP: ' + SMBRPtxtArea + '  &nbsp;&nbsp; ' + 'CA: ' + CAtxtArea + '  &nbsp;&nbsp; ' + 'P: ' + PhostxtArea + '  &nbsp;&nbsp; ' + 'MG: ' + MGtxtArea + '  &nbsp;&nbsp; ' + 'SE: ' + SEtxtArea + '  &nbsp;&nbsp; ' + 'TS: ' + TStxtArea + "</h4>");
			...
			if ((MJtxtArea2 == 0)) {
				...
				$("#Foodfield2").show();
				$("#Foodfield2").html("<h4>" + 'Kolumnen: 2' + '<br/>' + 'MJ: ' + MJtxtArea2 + '  &nbsp;&nbsp; ' + 'SMBRP: ' + SMBRPtxtArea2 + '  &nbsp;&nbsp; ' + 'CA: ' + CAtxtArea2 + '  &nbsp;&nbsp; ' + 'P: ' + PhostxtArea2 + '  &nbsp;&nbsp; ' + 'MG: ' + MGtxtArea2 + '  &nbsp;&nbsp; ' + 'SE: ' + SEtxtArea2 + '  &nbsp;&nbsp; ' + 'TS: ' + TStxtArea2 + "</h4>");
			...
			if ((MJtxtArea3 == 0)) {
				...
				$("#Foodfield3").show();
				$("#Foodfield3").html("<h4>" + 'Kolumnen: 3 ' + '<br/>' + 'MJ: ' + MJtxtArea3 + '  &nbsp;&nbsp; ' + 'SMBRP: ' + SMBRPtxtArea3 + '  &nbsp;&nbsp; ' + 'CA: ' + CAtxtArea3 + '  &nbsp;&nbsp; ' + 'P: ' + PhostxtArea3 + '  &nbsp;&nbsp; ' + 'MG: ' + MGtxtArea3 + '  &nbsp;&nbsp; ' + 'SE: ' + SEtxtArea3 + '  &nbsp;&nbsp; ' + 'TS: ' + TStxtArea3 + "</h4>");
			}
			...
			if ((MJDive1 == 0)) {
				...
				$("#Diversefield1").show();
				$("#Diversefield1").html('<h3>' + 'Diverse Fodermedel' + '</h3>' + "<h4>" + 'Kolumnen: 1 ' + '<br/>' + 'MJ: ' + MJDive1 + '  &nbsp;&nbsp; ' + 'SMBRP: ' + SMBRPDive1 + '  &nbsp;&nbsp; ' + 'CA: ' + CADive1 + '  &nbsp;&nbsp; ' + 'P: ' + PhosDive1 + '  &nbsp;&nbsp; ' + 'MG: ' + MGDive1 + '  &nbsp;&nbsp; ' + 'SE: ' + SEDive1 + '  &nbsp;&nbsp; ' + 'TS: ' + TSDive1 + "</h4>");
			}
			...
			if ((MJDive2 == 0)) {
				...
				$("#Diversefield2").show();
				$("#Diversefield2").html("<h4>" + 'Kolumnen: 2 ' + '<br/>' + 'MJ: ' + MJDive2 + '  &nbsp;&nbsp; ' + 'SMBRP: ' + SMBRPDive2 + '  &nbsp;&nbsp; ' + 'CA: ' + CADive2 + '  &nbsp;&nbsp; ' + 'P: ' + PhosDive2 + '  &nbsp;&nbsp; ' + 'MG: ' + MGDive2 + '  &nbsp;&nbsp; ' + 'SE: ' + SEDive2 + '  &nbsp;&nbsp; ' + 'TS: ' + TSDive2 + "</h4>");
			}
			...
			if ((MJDive3 == 0)) {
				...
				$("#Diversefield3").show();
				$("#Diversefield3").html("<h4>" + 'Kolumnen: 3 ' + '<br/>' + 'MJ: ' + MJDive3 + '  &nbsp;&nbsp; ' + 'SMBRP: ' + SMBRPDive3 + '  &nbsp;&nbsp; ' + 'CA: ' + CADive3 + '  &nbsp;&nbsp; ' + 'P: ' + PhosDive3 + '  &nbsp;&nbsp; ' + 'MG: ' + MGDive3 + '  &nbsp;&nbsp; ' + 'SE: ' + SEDive3 + '  &nbsp;&nbsp; ' + 'TS: ' + TSDive3 + "</h4>");
			}
		});
	}).attr('target', '_blank');