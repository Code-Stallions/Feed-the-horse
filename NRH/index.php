<?php include'Head.php'; ?>		
			...
			<div class="row">
		   		<div class="span8"> 
		   			...
		   			<form action="" target="_blank" class="form-horizontal" id="horseForm" name="form1" method="post" enctype="multipart/form-data">
		   			
		   				<div class="table"> <!-- start of whole table -->
		   					...
		   					<div class="control-group radio " id="horseSelect" >
		   						...
		   						<input type="radio" id="female" name="horseType" value="Hona / Kastrerad "/>Hona / Kastrerad  
		   						 ...
		   						 <div class="control-group">
		   						<input type="radio" id="Draktig" name="horseType" value="Dräktig"/>Dräktig
		   						<input type="checkbox" id="EightMonths" class="checkbox" name="Months" value="EightMonths"/>&nbsp;8/9 Månad
		   						<input type="checkbox" id="TenMonths" 	 class="checkbox" name="Months" value="TenMonths"/>&nbsp;10 Månad
		   						<input type="checkbox" id="ElevenMonths"  class="checkbox" name="Months" value="ElevenMonths"/>&nbsp;11 Månad 
		   						 </div>
		   						<div class="control-group">
		   						<input type="radio" id="Hane" name="horseType" value="Hane"/>Hane
		   						<input type="text" id="HaneMonths" name="HaneMonths" value="" class="numbersOnly input-mini"/>&nbsp;Månad 
		   						</div>
		   						<div class="control-group">
		   						<input type="radio" id="Hingst"  name="horseType" value="Hingst"/>Hingst
		   						</div>
		   					
		   						<a href="#1" id="icon1" class="btn btn-success pull-right" rel="popover" data-content="Välj den typen av häst du har, resultatet kommer bero på vilken typ av häst du valde.om du valde ung häst så skriv åldern av hästen i månader.">Info</a>
		   					</div>
		   				
		   					
		   					<div class="control-group" id="weighttype">
		   						 <!-- <div class="weighttype"> This is div holds different type of weights -->
		 							<legend>Ange din hästs ideala vikt.</legend> <!-- input for accurate weight -->                     
		 								<input type="text" name="weight" id="weight2" class="numbersOnly input-mini" value=""/>&nbsp;Kg<br/><br/>
		 									<a href="horse_scale.php" class="nextButton"> klicka här</a>
		 						    		Om du inte vet din häst vikt
		 						    		<a href="#2" id="icon2" class="btn btn-success pull-right" rel="popover" data-content="Ange dina hästars vikt i kg använd endast siffror." data-origina-title="Info">Info</a>
		 						 </div>
		   					
		   							<div class="control-group" id="horsetype" >		<!--This is div holds different type of horses -->
		 						    	<legend>Välj den utfodring typ.</legend>
		 						    	<label>	
		 						    		<input type="radio" id="latt"   name="horse" value="Lätt"/>		Lättfödd&nbsp;&nbsp;&nbsp;  
		 						    		<input type="radio" id="normal" name="horse" value="Normal"/>	Normalfödd&nbsp;&nbsp;&nbsp; 
		 						    		<input type="radio" id="svart"  name="horse" value="Svart"/>  	Svårfödd 
		 						    	</label>
		 						    <a href="#3" id="icon3" class="btn btn-success pull-right" rel="popover" data-content="Ange vilken typ av häst du har." data-origina-title="Info">Info</a>
		 							</div>
		 							
		 							<div class="control-group" id="FatSkinny" > 	<!--This is div holds different type of horses weight-->
		 						    			<legend>Är din häst för smal eller tjock?</legend>
		 						    			<input type="radio" id="Small"   name="horsefiger" value="Smal"/>    Smal &nbsp;&nbsp;&nbsp; 
		 						    			<input type="radio" id="Normal" name="horsefiger" value="Normal"/>  Normal &nbsp;&nbsp;&nbsp; 
		 						    			<input type="radio" id="Tjok"  name="horsefiger" value="Tjock"/>    Tjock 
		 						    			<br/><br/>	
		 						    			<a href="horseWeight.php" class="nextButton"> klicka här </a>&nbsp;&nbsp;
		 						    			Om du inte vet hullbedömning av hästar
		 						    					<a href="#4" id="icon4" class="btn btn-success pull-right" rel="popover" data-content="Välja vilket tillståndet din häst är i just nu." data-origina-title="Info">Info</a>
		 						  </div>

		   			
		 							<div class="control-group" id="Foodtable">
		 						    			<legend>Skriv in vilken typ av hö du har.</legend>
		 						    			<input type="text" name="hayInput" id="hayInput" placeholder="Text" class="hayInput input-mini" /><br/><br/><br/>
		 						  
		 						    			<input type="text" name="FoodWeight" id="FoodWeight"  class="numbersOnly input-mini" value=""/> Kg
		 						    			<br/><br/>
		 						    			<input type="button" id="AddTextField" class="btn"name="AddTextField" value="Nytt Fält"/>
		 						    			<br/><br/>
		 						    		...
		 						    		<a href="#" id="icon7" class="btn btn-success pull-right" rel="popover" data-content="Välj den typ av protein du har så att du kan se hur mycket mineraler och energi maten innehåller" data-origina-title="Info">Info</a>
		 						    </div>
		   			
		 						    <div class="checkbox control-group" id="ProteinFoder">
		 						    	<legend>Välj de Proteinfodermedel du har tillgängligt.</legend>
		 						    	   <input type="checkbox" class="checkbox" id="Bryggerijast" name="food" value="0" /> Bryggerijäst<br/>
		 						  ...
		 						  <div id="FoodRowTable" class="control-group">
		 						   ...
		 						   <div class="checkbox control-group" id="DiverseFoder">
		 						 		<legend>Välj den Diverse Fodermedel du har tillgängligt.</legend>
		 						       		<input type="checkbox" class="checkbox" id="Aspbark" name="food" value="0"/> Aspbark<br/>
		 						    		...
		 						    		<input type="checkbox" class="checkbox" id="Vegetabilisk"	name="food" value="6"/>Vegetabiliskt fett (oija)<br/><br/><br/>	
		 						    </div>
		 						 	 			
		 						 	<div class="control-group" id="EndFoodtable" > 
		 						 	 <input type="button" id="AddFoodText2" class="btn" name="AddFoodText2" value="Nytt Fält"/>
		 						 	 ...
		 						 	 <table class="table table-bordered" id="FoodRow11" >
		 						    		...
		 						    		<a href="#8" id="icon8" class="btn btn-success pull-right" rel="popover" data-content="Välj den typ av mat du har så att du kan se hur mycket mineraler och energi maten innehåller" data-origina-title="Info">Info</a>
		 						    	
		 						    	<a href="#ResultBody" data-toggle="modal" ><input type="button" value ="Räkna ut" class="btn btn-large btn-primary" name="submit" id="calcu" data-toggle="modal" /></a>
		...
		<div id="ResultBody" class="modal hide fade" aria-hidden="true" ><!--This is result viewer and holds gray color body -->
